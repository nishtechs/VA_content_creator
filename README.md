...
| **Visual Designer** | Generates dark cyber-themed HTML slide page | `@remotion/mcp`, `@mcp/svg-generator`, `@lottiefiles/creator-mcp`, `stylelint-mcp`, `prettier-mcp`, `exa-mcp-server`, `@madhan-g-p/devdocs-mcp-server` (MCP Servers via Stdio) |
